          ...
          >
            <Link href="/contact">
              <AudioButton
                ...
                className="bg-gradient-to-r from-orange-600 to-red-600 text-white font-bold px-8 py-4 rounded-full shadow-2xl inline-flex items-center"
              >
                ...
                >
                  <div className="relative h-full overflow-hidden rounded-lg">
                    ...
                    <div
                      ...
                      style={{
                        background: `linear-gradient(${45 + Math.sin(time + i) * 30}deg, rgba(251, 191, 36, ${0.8 + Math.sin(time * 0.5) * 0.2}), rgba(239, 68, 68, ${0.7 + Math.cos(time * 0.7) * 0.2}), rgba(245, 101, 101, ${0.6 + Math.sin(time * 0.9) * 0.3}))`,
                      }}
                    />
