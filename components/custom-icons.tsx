export const CustomIcons = {
  ...
  Templates: () => (
    <svg
      ...
      className="text-orange-200 group-hover:text-white transition-colors duration-300"
    >
      <path d="M4 6C4 4.89543 4.89543 4 6 4H18C19.1046 4 20 4.89543 20 6V8H4V6Z" fill="currentColor" />
      <path
  ...
  Projects: () => (
    ...
    >
      <path
        d="M4.5 16.5C3 15 3 12.5 3 12.5S3 10 4.5 8.5C6 7 8.5 7 8.5 7S11 7 12.5 8.5C14 10 14 12.5 14 12.5S14 15 12.5 16.5C11 18 8.5 18 8.5 18S6 18 4.5 16.5Z"
        stroke="currentColor"
        strokeWidth="2"
      />
      <path d="M10 12L14 8L22 16L18 20L10 12Z" fill="currentColor" />
      <path d="M15 9L20 14" stroke="currentColor" strokeWidth="2" />
    </svg>
  ),
  Contact: () => (
    <svg
